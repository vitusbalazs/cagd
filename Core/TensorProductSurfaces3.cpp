...
// product surface
TriangulatedMesh3*
TensorProductSurface3::GenerateImage(GLuint u_div_point_count,
...
GLboolean
TensorProductSurface3::UpdateDataForInterpolation(
...
GLvoid
TensorProductSurface3::PartialDerivatives::LoadNullVectors()
{
...
TensorProductSurface3::TensorProductSurface3(GLdouble u_min,
                                             GLdouble u_max,
                                             GLdouble v_min,
                                             GLdouble v_max,
                                             GLuint row_count,
...
GLvoid
TensorProductSurface3::SetUInterval(GLdouble u_min, GLdouble u_max)
{
  _u_min = u_min;
  _u_max = u_max;
}
GLvoid
TensorProductSurface3::SetVInterval(GLdouble v_min, GLdouble v_max)
{
  _v_min = v_min;
  _v_max = v_max;
}
...
GLvoid
TensorProductSurface3::GetUInterval(GLdouble& u_min, GLdouble& u_max) const
{
  u_min = _u_min;
  u_max = _u_max;
}
GLvoid
TensorProductSurface3::GetVInterval(GLdouble& v_min, GLdouble& v_max) const
{
  v_min = _v_min;
  v_max = _v_max;
}
...
GLboolean
TensorProductSurface3::SetData(GLuint row,
                               GLuint column,
                               GLdouble x,
                               GLdouble y,
                               GLdouble z)
...
GLboolean
TensorProductSurface3::GetData(GLuint row,
                               GLuint column,
                               GLdouble& x,
                               GLdouble& y,
                               GLdouble& z) const
...
// homework: get data // homework: VBO handling methods
GLvoid
TensorProductSurface3::DeleteVertexBufferObjectsOfData()
{
  if (_vbo_data) {
...
GLboolean
TensorProductSurface3::RenderData(GLenum render_mode) const
{
  if (!_vbo_data) {
    return GL_FALSE;
  }
  if (render_mode != GL_POINTS && render_mode != GL_LINE_STRIP &&
...
RowMatrix<GenericCurve3*>*
TensorProductSurface3::GenerateUIsoparametricLines(
...
RowMatrix<GenericCurve3*>*
TensorProductSurface3::GenerateVIsoparametricLines(
  GLuint iso_line_count,
  GLuint maximum_order_of_derivatives,
  GLuint div_point_count,
  GLenum usage_flag) const
...
DCoordinate3
TensorProductSurface3::operator()(GLuint row, GLuint column) const
{
...
DCoordinate3&
TensorProductSurface3::operator()(GLuint row, GLuint column)
{
